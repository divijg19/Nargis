...
class Goal(Base):
    ...
    milestones: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Array of milestone objects
    linked_task_ids: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Array of task IDs
    linked_habit_ids: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Array of habit IDs
    ai_suggestions: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # Array of AI suggestions
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class JournalEntry(Base):
    ...
    mood: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)  # great | good | neutral | bad | terrible
...
class PomodoroSession(Base):
    ...
    type: Mapped[str] = mapped_column(String(20), default="work")  # work | short_break | long_break
