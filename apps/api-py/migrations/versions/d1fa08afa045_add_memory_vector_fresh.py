...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("pomodoro_sessions_user_id_fkey")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pomodoro_sessions_pkey")),
    )
    op.create_index(
        op.f("ix_pomodoro_sessions_user_id"),
        "pomodoro_sessions",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("habits_user_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("goals_user_id_fkey")
        ),
