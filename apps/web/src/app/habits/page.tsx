...
export default function HabitsPage() {
    const { todayProgress, totalStreaks, loadHabits, addHabit, updateHabitCount } = useHabitStore();
        ...
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div className="animate-fade-in">
                    ...
                    {/* Streak Summary */}
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-orange-100 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            ...
                                            <span
                                                className={`text-xs px-2.5 py-1 rounded-full font-semibold ${isComplete
