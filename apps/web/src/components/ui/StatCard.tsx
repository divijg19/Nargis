...
export function StatCard({ title, value, icon, className }: StatCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-primary/10 via-accent/10 to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
