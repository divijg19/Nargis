			...
			<div className="space-y-4">
				...
				<div>
					...
					<input
						...
						className={`w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-800 text-foreground dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.name
								? "border-red-500"
					...
					<div className="flex gap-2 flex-wrap">
						{ICON_OPTIONS.map((emojiIcon) => (
							<button
								...
								className={`w-12 h-12 text-2xl rounded-lg border-2 transition-all ${icon === emojiIcon
				...
				<div className="grid grid-cols-2 gap-3">
					<div>
						...
						<input
							...
							className={`w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-800 text-foreground dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.target
									? "border-red-500"
									: "border-gray-300 dark:border-gray-600"
								}`}
						/>
					...
					<div className="flex gap-2">
						{FREQUENCY_OPTIONS.map((option) => (
							<button
								...
								className={`flex-1 px-4 py-2 rounded-lg border-2 font-medium transition-all ${frequency === option.value
					...
					<div className="flex gap-2 flex-wrap">
						{COLOR_OPTIONS.map((colorOption) => (
							<button
								...
								className={`w-10 h-10 rounded-lg border-2 transition-all ${color === colorOption
