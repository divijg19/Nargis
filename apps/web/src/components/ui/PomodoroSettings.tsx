                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                onChange={(e) =>
                                    setShortBreakDuration(Number.parseInt(e.target.value, 10) || 5)
                                }
                                className="flex-1 px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                            />
                            <span className="text-sm text-muted-foreground min-w-[60px]">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-3">
                            <input
                                ...
                                onChange={(e) =>
                                    setLongBreakDuration(Number.parseInt(e.target.value, 10) || 15)
                                }
                                className="flex-1 px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                            />
                            <span className="text-sm text-muted-foreground min-w-[60px]">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${autoStartBreaks ? "bg-blue-600" : "bg-gray-200 dark:bg-gray-700"
                                }`}
                            role="switch"
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${autoStartWork ? "bg-blue-600" : "bg-gray-200 dark:bg-gray-700"
                                }`}
                            role="switch"
                            aria-checked={autoStartWork}
                        >
                            <span
                                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${autoStartWork ? "translate-x-6" : "translate-x-1"
                                    }`}
                            />
                        </button>
                    </div>
