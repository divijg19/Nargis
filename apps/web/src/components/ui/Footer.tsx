...
export function Footer() {
	...
	return (
		<footer
			className={`fixed bottom-4 left-4 right-4 z-40 transition-all duration-300 ease-out ${isVisible ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"
				}`}>
						...
						<div className="flex items-center justify-between h-12 text-sm">
							<div className="flex items-center space-x-4">
								<p className="text-muted-foreground">
									© 2025 <span className="font-semibold text-foreground">Nargis</span>
								</p>
							...
							<div className="flex items-center space-x-3 text-muted-foreground">
								<div className="hidden md:flex items-center space-x-2">
									...
									<span className="text-xs font-medium">Premium AI Productivity</span>
								</div>
