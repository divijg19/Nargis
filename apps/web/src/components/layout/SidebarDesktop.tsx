    ...
    >
      ...
      >
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-structural bg-transparent hover:bg-hover/20 transition-[color,background-color,border-color,opacity,box-shadow,transform]"
        ...
        <button
          ...
          className={
            !collapsed
              ...
              : "p-2 rounded border border-structural text-foreground bg-transparent w-9 h-9 inline-flex items-center justify-center"
          }
